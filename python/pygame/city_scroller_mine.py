...
class Scroller(object):
	...
	def add_building(self, x_location):
		...
		building = Building(x_location, self.height, random.randint(50, 100), random.randint(100, 250), self.color)
...
front_scroller = Scroller(SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_HEIGHT, FRONT_SCROLLER_COLOR, 3)
middle_scroller = Scroller(SCREEN_WIDTH, SCREEN_HEIGHT-100, (SCREEN_HEIGHT - 50), MIDDLE_SCROLLER_COLOR, 2)
back_scroller = Scroller(SCREEN_WIDTH, SCREEN_HEIGHT-200, (SCREEN_HEIGHT - 100), BACK_SCROLLER_COLOR, 1)
