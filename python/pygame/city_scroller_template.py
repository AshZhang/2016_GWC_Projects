...
class Scroller(object):
	...
	def add_buildings(self):
		...
		x = 0
		while total < 15000:
			building_width = self.add_building(x)
			x += building_width
			total += building_width
	...
	def add_building(self, x_location):
		...
		building = Building(x_location, self.height, random_width, random.randint(100, 400), self.color)
...
while not done:
	...
	# build = Building(100, 100, 50, 50, RED)
	# build.draw()
	# build.move(10)
